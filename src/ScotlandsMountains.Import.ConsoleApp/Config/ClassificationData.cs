...
internal class ClassificationData : IEnumerable<ClassificationInfo>
{
    private static readonly IEnumerable<ClassificationInfo> Items = new List<ClassificationInfo>
    {
        ...
        new ("County Tops Twins (historic pre-1974)", null, false, "County Top Twin (historic pre-1974)", x => x.CountyTopHistoricPre1974Twin, "The highest point within (or sometimes on) the boundary of each county."),
        ...
        new ("County Top Twins (current county or unitary authority)", null, false, "County Top Twin (current county or unitary authority)", x => x.CountyTopCurrentCountyorUnitaryAuthorityTwin, "The highest point within (or sometimes on) the boundary of each county."),
        ...
        new ("County Top Twins (administrative 1974 to mid-1990s)", null, false, "County Top Twin (administrative 1974 to mid-1990s)", x => x.CountyTopAdministrative1974ToMid1990sTwin, "The highest point within (or sometimes on) the boundary of each county."),
        ...
        new ("County Top Twins (current London borough)", null, false, "County Top Twin (current London borough)", x => x.CountyTopCurrentLondonBoroughTwin, "The highest point within (or sometimes on) the boundary of each county."),
